...
class BaseMaskRCNNHead(nn.Module):
    ...
    def forward(self, x, instances: List[Instances]):
        ...
        x = self.layers(x)
        if self.training:
            return {"loss_mask": mask_rcnn_loss(x, instances, self.vis_period) * self.loss_weight}, x # for MMA
            # return {"loss_mask": mask_rcnn_loss(x, instances, self.vis_period) * self.loss_weight} # for MMA
        else:
