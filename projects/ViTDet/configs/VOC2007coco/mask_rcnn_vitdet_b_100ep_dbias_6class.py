...
TRAIN_PATH = os.path.join(DATASET_ROOT, 'trainval_6class')
VAL_PATH = os.path.join(DATASET_ROOT, 'test_6class') 
TRAIN_JSON = os.path.join(ANN_ROOT, 'trainval_6class.json')
VAL_JSON = os.path.join(ANN_ROOT, 'test_6class.json') 
...
DatasetCatalog.register("voc2007coco_trainval_6class", lambda: load_coco_json(TRAIN_JSON, TRAIN_PATH, "voc2007coco_trainval_6class"))
MetadataCatalog.get("voc2007coco_trainval_6class").set(json_file=TRAIN_JSON, image_root=TRAIN_PATH, evaluator_type="coco", **get_dataset_instances_meta_train())
...
DatasetCatalog.register("voc2007coco_test_6class", lambda: load_coco_json(VAL_JSON, VAL_PATH, "voc2007coco_test_6class"))
MetadataCatalog.get("voc2007coco_test_6class").set(json_file=VAL_JSON, image_root=VAL_PATH, evaluator_type="coco", **get_dataset_instances_meta_val())

dataloader.train.dataset.names = "voc2007coco_trainval_6class"
...
dataloader.test.dataset.names = "voc2007coco_test_6class" # voc2007coco_test_6class
...
lr_multiplier.scheduler.milestones = [25000, 34000]
