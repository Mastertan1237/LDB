...
DatasetCatalog.register("comiccoco_train", lambda: load_coco_json(TRAIN_JSON, TRAIN_PATH, "comiccoco_train"))
MetadataCatalog.get("comiccoco_train").set(json_file=TRAIN_JSON, image_root=TRAIN_PATH, evaluator_type="coco", **get_dataset_instances_meta_train())
...
DatasetCatalog.register("comiccoco_test", lambda: load_coco_json(TEST_JSON, TEST_PATH, "comiccoco_test"))
MetadataCatalog.get("comiccoco_test").set(json_file=TEST_JSON, image_root=TEST_PATH, evaluator_type="coco", **get_dataset_instances_meta_test())

dataloader.train.dataset.names = "comiccoco_train"
...
dataloader.test.dataset.names = "comiccoco_test"
