...
from detectron2.evaluation import inference_on_dataset_eval, print_csv_format
from detectron2.utils import comm

logger = logging.getLogger("detectron2")


def do_test(cfg, model, original_model):
    if "evaluator" in cfg.dataloader:
        ret = inference_on_dataset_eval(
...
def main(args):
    ...
    if args.eval_only:
        ...
        do_test(cfg, model, original_model)
    else:
        do_train(args, cfg)
